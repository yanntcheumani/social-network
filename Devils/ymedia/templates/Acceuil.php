...
<html>
	...
	<body class="bg-white" style="margin: 0px;">
				...
				<div class="col-3">
					...
					<div class="card bg-white">
						...
						<div class="card-body bg-white">
							<div class="card-text">
								<button class="btn btn-outline-primary">Modifier mon profil</button>
							</div>
						</div>
					...
					<div class="card mt-2">
						...
						<div class="card-body h-75 bg-white scroll">
							<ul class="w-100 list-group">
							  	<li class="border-bottom pb-1" style="list-style-type: none; ">
							  		<img src="../logo_php.png" style="max-height: 50px; max-width: 100%; width: 100%; display: hidden; border: 1px solid red;">
							  	</li>
							  	<li class="border-bottom pb-1" style="list-style-type: none; ">
							  		<img src="../logo_php.png" style="max-height: 50px; max-width: 100%; width: 100%; border: 1px solid red; display: hidden;">
							  	</li>
							  	<li class="border-bottom pb-1" style="list-style-type: none; ">
							  		<img src="../logo_php.png" style="max-height: 50px; max-width: 100%; width: 100%; border: 1px solid red;">
							  	</li>
							</ul>
						</div>
					</div>
					...
					<div class="card mt-2">
						<div class="card-header border-0 bg-white">
							...
							<div class="card-body w-100">
								<img src="../logo_php.png" width="900" style="max-width: 2000px; width: 100%;">
		...
		<section class=" d-none d-lg-block d-xl-none text-center">
			<nav class="navbar navbar-expand-sm bg-light navbar-dark fixed-top" style="border-bottom: 1px solid gray">
			  	<div class="row w-100">
			  		<li class="col-9 text-left float-left" style=" list-style-type: none;">
			  			<a href="Acceuil.php" class="" style="color: #ff00ff; font-size: 20px;">
			  				Devil's
			  			</a>
			  		</li>
			  		...
			  		<li class="col-3 float-right text-right mt-2" style=" list-style-type: none;">
			  			<a href="Message_recep_Mobile.php" class="text-dark " >
			...
			<div class="card mr-5 ml-5" style="margin-top: 80px;">
				<div class="card-header border-0 bg-white">
					...
					<!--end  header div publication-->
					<div class="card-body">
						<img src="../logo_php.png" width="900" style="max-width: 950px; width: 100%">
						<div class="row border-top">
							<div class="col-1">
								<i class="far fa-heart mt-2" style="font-size: 30px;"></i>
							</div>
			...
			<div class="card mr-5 ml-5 mb-5" style="margin-top: 80px;">
				<div class="card-header border-0 bg-white">
		...
		<section class="m-0 p-0 d-none d-md-block d-lg-none">
			<nav class="navbar navbar-expand-sm bg-light navbar-dark fixed-top" style="border-bottom: 1px solid gray">
			  	<div class="row w-100">
			  		...
			  		<li class="col-3 float-right text-right mt-2" style=" list-style-type: none;">
			  			<a href="Message_Mobile.php" class="text-dark " >
			...
			<div class="card mr-5 ml-5 pb-5" style="margin-top: 80px;">
				<div class="card-header border-0 bg-white">
					...
					<!--end  header div publication-->
					<div class="card-body">
						<img src="../logo_php.png" style="max-width: 950px; width: 100%">
						<div class="row border-top">
							<div class="col-1">
								<i class="far fa-heart mt-2" style="font-size: 30px;"></i>
							</div>
